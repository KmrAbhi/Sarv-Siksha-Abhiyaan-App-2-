...
public class BodyParts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        images[0] = R.drawable.stomach;
        images[1] = R.drawable.nose;
        images[2] = R.drawable.ear;
        images[3] = R.drawable.eye;
        images[4] = R.drawable.legs;
        images[5] = R.drawable.hand;
        images[6] = R.drawable.forhead;
        images[7] = R.drawable.teeth;
        images[8] = R.drawable.lips;
        images[9] = R.drawable.hair;
        imagename[0] = "Stomach";
        imagename[1] = "Nose";
        imagename[2] = "Ear";
        imagename[3] = "Eye";
        ...
        final Intent getmenu=new Intent(BodyParts.this,GameHome.class);
